...
namespace MobilePatterns.Controllers
{
	public class SettingsViewController : BaseDialogViewController
	{
		...
		public override void ViewWillAppear (bool animated)
		{
			...
			supportSection.Add(new StyledElement("Technical Support", () => UIApplication.SharedApplication.OpenUrl(new NSUrl("http://appreciateui.freshdesk.com/"))));
			...
			aboutSection.Add(new StyledElement("Rate This App", () => UIApplication.SharedApplication.OpenUrl(new NSUrl("https://itunes.apple.com/us/app/appreciateui/id651317060?ls=1&mt=8"))));
